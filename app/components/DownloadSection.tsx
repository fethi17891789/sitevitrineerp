        ...
        <div className="border-spotlight rounded-[64px] p-[1px] overflow-hidden shadow-[0_50px_100px_rgba(0,0,0,0.8)]">
          <div className="silver-glass rounded-[64px] p-20 md:p-32 relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col justify-center items-center">
              <h2 className="text-[clamp(1.5rem,7vw,4.5rem)] font-black tracking-tighter mb-10 text-white leading-[1] text-gradient-silver">
                L&apos;industrie de <br/> demain, aujourd&apos;hui.
              </h2>
              
              <p className="text-white/50 text-[19px] mb-16 max-w-[500px] font-medium leading-relaxed">
